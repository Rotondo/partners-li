...
const PartnersMarketplace = () => {
  ...
  // Carregar parceiros de marketplace
  const { data: partners = [] } = useQuery({
    ...
    queryFn: async () => {
      ...
      return (data || []).map((p: any) => ({
        id: p.id,
        name: p.data.name,
        categories: ['marketplace' as const],
        ...
        <div className="container mx-auto p-8">
          <Tabs defaultValue="list" className="w-full">
            ...
            <TabsContent value="compare">
              <PartnerComparator partners={partners} initialCategory="marketplace" />
            </TabsContent>
          </Tabs>
        </div>
      </main>
